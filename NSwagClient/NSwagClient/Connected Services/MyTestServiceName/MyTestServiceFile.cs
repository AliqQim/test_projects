...
namespace NSwagClient.MyTestServiceName
{
    ...
    public partial class Client 
    {
        ...
        public System.Threading.Tasks.Task<System.Collections.Generic.ICollection<WeatherForecast>> WeatherforecastGetAsync()
        {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<WeatherForecast>> WeatherforecastGetAsync(System.Threading.CancellationToken cancellationToken)
        {
        ...
        /// ну это же WebAPI.Core.Controllers.WeatherForecastController</summary>
        ...
        /// <summary>проверяем, является ли особа годной телочкой. см. WebAPI.Core.Controllers.WeatherForecastController.Person</summary>
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<bool> WeatherforecastIsavailableforchattingupAsync(Person body)
        {
            return WeatherforecastIsavailableforchattingupAsync(body, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<bool> WeatherforecastIsavailableforchattingupAsync(Person body, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/WeatherForecast/IsAvailableForChattingUp");
    ...
    /// <summary>особа для проверки</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.1.21.0 (Newtonsoft.Json v12.0.0.2)")]
    public partial class Person 
    {
        /// <summary>имя особы</summary>
        ...
        /// <summary>пол особы</summary>
        [Newtonsoft.Json.JsonProperty("isFemale", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
